                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div style="margin: 0 5px; text-align: right;">
                                        <label>
                                            <input style="vertical-align: middle; margin-top: 0;" type="checkbox" id="foodnearlyexpirydate">Generate 6 months nearly expiry date
                                        </label>
                                    </div>

                                    <div style="margin: 0 5px; text-align: center;"><u><h5>Food Inventory</h5></u></div>
