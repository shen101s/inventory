...
<body class="">
        ...
        <div class="content-wrapper" id="content-wrapper">
            <section class="content section">
                <div class="container-fluid">
                     CHECK SERVICES. DELETE INI NA MEDIDINE PAGE
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-header">
                                    ...
                                    <span class="pull-right">
                                        <a href="javascript:void(0);" class="btn btn-success btn-sm" id="med_addmed">Add Medicine</a>
                                    </span>
                                </div>
                                <div class="panel-body">

                                    <table class="table table-striped" id="tbl_dt_medindex">
                                        <thead>
                                            <tr>
                                                <th>Description</th>
                                                <th>Status</th>
    ...
    <script type="text/javascript" src="<?php echo base_url() . 'assets/js/medicinesindex.js'; ?>"></script>
</body>